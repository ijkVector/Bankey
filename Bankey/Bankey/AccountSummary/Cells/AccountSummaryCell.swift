...
class AccountSummaryCell: UITableViewCell {
    ...
    static let reuseID = "AccoutSummaryCell"
...
private extension AccountSummaryCell {
    ...
    func setup() {
        ...
        balanceAmountLabel.attributedText = makeFormatedBalance(dollars: "XXX,XXX", cents: "XX")
    ...
    func makeFormatedBalance(dollars: String, cents: String) -> NSMutableAttributedString {
