...
class OnboardingContainerViewController: UIViewController {
    ...
    var currentVC: UIViewController {
        didSet {
            ...
            doneButton.isHidden = !(index == pages.count - 1) // hid if not on last page
//            print(index)
        }
    }
    ...
    override init(nibName nibNameOrNil: String?, bundle nibBundleOrNil: Bundle?) {
        ...
        let page1 = OnboardingViewController(heroName: "delorean", titleText: "Bankey is faster, easier to use, and has a brand new look and feel that will make you feel like you are back in the 2019.")
        let page2 = OnboardingViewController(heroName: "world", titleText: "Move your money around the world quickly and securely")
        let page3 = OnboardingViewController(heroName: "thumbs", titleText: "Learn more at www.bankey.com")
...
extension OnboardingContainerViewController {
    ...
    @objc func backTapped(_ sender: UIButton) {
        guard let previosVC = getPreviousViewController(from: currentVC) else { return }
        pageViewController.setViewControllers([previosVC], direction: .reverse, animated: true)
    }
